...
export const defaultMilitaryRules: BenefitRuleDefinition[] = [
  ...
  },
  {
    ...
    categoryName: "One-Time Lump Sum",
    categoryThaiName: "หมวด 1: รับเงินครั้งเดียว",
    description: "เงินบำรุงขวัญกำลังพล: กรณีเสียชีวิตหรือพิการทุพพลภาพรับ 40,000 บาท; กรณีบาดเจ็บและพักรักษาตัวในโรงพยาบาลไม่เกิน 10 วันรับ 10,000 บาท; กรณีบาดเจ็บพักรักษาตัว 11-20 วันขึ้นไป (>= 20 วัน) รับเพิ่มอีก 10,000 บาท รวม 20,000 บาท",
    ...
    maxAmount: 40000,
    conditions: {
      allowedMissions: ["SOUTHERN_BORDER", "BORDER_DEFENSE", "INTERNAL_SECURITY", "COUNTER_INSURGENCY", "ALL"],
      allowedLossTypes: ["KIA_COMBAT_DEATH", "DUTY_DEATH", "TOTAL_PERMANENT_DISABILITY", "PARTIAL_DISABILITY", "SEVERE_WOUND_WIA", "MODERATE_INJURY", "MINOR_INJURY", "ALL"],
    },
    formulaTiers: [
