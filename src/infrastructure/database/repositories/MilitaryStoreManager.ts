...
export const initialMilitaryPersonnel: MilitaryPersonnelRecord[] = [
  {
    ...
    rankAppointmentTo: "พลเอก",
    salaryLevelAdjustment: "น.3 ขั้น 27.5",
  ...
  },
  {
    ...
    lossType: "KIA_COMBAT_DEATH",
    hospitalAdmissionDate: "2026-05-20",
    hospitalDischargeDate: "2026-06-15",
    promotionSteps: 8,
    promotedRank: "MAJOR",
  ...
  },
  {
    ...
    lastName: "หาญสงคราม",
    militaryBranch: "ROYAL_THAI_ARMY",
    abbreviatedPosition: "ผบ.หมู่ ปล. ร้อย.ร.1532",
    normalUnit: "ร.153 พัน.2 (พล.ร.15)",
    fieldPosition: "หน.ชุด ชป.จรยุทธ์ ฉก.ทพ.45",
    fieldUnit: "กรมทหารพรานที่ 45 (นราธิวาส)",
    salary: 21800,
    salaryLevel: "ป.2",
    salaryStep: 15.0,
    ...
    lossType: "KIA_COMBAT_DEATH",
    hospitalAdmissionDate: "2026-06-18",
    hospitalDischargeDate: "2026-06-30",
    promotionSteps: 7,
...
export const initialGeneratedDocuments: GeneratedDocumentRecord[] = [
  {
    ...
    qrVerifyCode: "VERIFY-RTA-BENEFIT-2569-00142-SECURE",
    status: "OFFICIAL_ISSUED",
    createdAt: new Date("2026-03-15"),
  },
  {
    id: "doc-002",
    docNumber: "กห-0401/2569-00188",
    ...
    qrVerifyCode: "VERIFY-RTA-BENEFIT-2569-00188-SECURE",
    status: "OFFICIAL_ISSUED",
    createdAt: new Date("2026-04-10"),
  },
];
